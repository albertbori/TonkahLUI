...
Omen3DB = {
	...
	["profiles"] = {
		["Tonkah LUI"] = {
			["PositionW"] = 194.885894775391,
			["Shown"] = true,
			["PositionH"] = 195.984939575195,
			["VGrip2"] = 152.1929321179,
			["PositionY"] = 232.178039550781,
			["Locked"] = true,
			["Background"] = {
				["EdgeSize"] = 9,
				["BorderTexture"] = "None",
		...
		["Marmit - Doomhammer"] = {
			...
			["PositionH"] = 196.984909057617,
			["VGrip2"] = 155.316689874038,
			["PositionY"] = 233.224670410156,
			["PositionX"] = 1247.11376953125,
			["Warnings"] = {
				["Sound"] = false,
			},
			["Locked"] = true,
