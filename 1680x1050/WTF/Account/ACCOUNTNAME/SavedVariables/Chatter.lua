	...
	["namespaces"] = {
		...
		["Editbox History"] = {
			["realm"] = {
				["Doomhammer"] = {
					["history"] = {
						" Omen is super disobedient", -- [1]
						" It's positioning mechanisms change between characters by a few pixels.", -- [2]
						" Just enough to make me upset.", -- [3]
						" I have a workaround, but my OCD is unhappy.", -- [4]
						" brb again", -- [5]
						"/gsse", -- [6]
						"/gsse", -- [7]
						"/lui", -- [8]
