if FW.CLASS == "DEATHKNIGHT" then
	...
	if ST then
		...
		:AddSpellRemap(45462,55078) -- Plague Strike to Blood Plague

		:AddSpell(55095,  21,"Default",	F.TICKS+F.REFRESH) -- Frost Fever, refreshed by Festering Strike
		:AddSpell(55078,  21,"Default",	F.TICKS+F.REFRESH) -- Blood Plague, refreshed by Festering Strike
		:AddSpell(155159, 30,"Default", F.TICKS+F.REFRESH)
